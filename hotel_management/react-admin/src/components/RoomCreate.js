...
export const RoomCreate = (props) => (
  <Create title="Create a Room" {...props}>  {/* Título para a criação do quarto */}
    <SimpleForm>
      <NumberInput source="hotelId" label="Hotel ID" />  {/* Campo para ID do hotel ao qual o quarto pertence */}
      <NumberInput source="roomtypeId" label="Room Type ID" />  {/* Campo para ID do tipo de quarto */}
